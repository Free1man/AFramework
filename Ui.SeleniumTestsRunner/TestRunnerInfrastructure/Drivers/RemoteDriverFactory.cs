...
using Ui.SeleniumTestsRunner.TestRunnerInfrastructure.Events;
...
namespace Ui.SeleniumTestsRunner.TestRunnerInfrastructure.Drivers
{
    ...
    internal class RemoteDriverFactory
    {
        ...
        {
            var type = Type.GetType($"Ui.SeleniumTestsRunner.TestRunnerInfrastructure.Drivers.{settings.Browser}Options");
