    ...
    internal class Settings : ISettings
    {
        ...
        public string RemoteDriverHubUrl
        {
            get
            {
                ...
                {
                    _remoteDriverHubUrl = _appConfigReader.ReadStringSettingFromAppConfig("RemoteDriverHubUrl", "http://localhost:4444/wd/hub");
                }
        ...
        public string Browser
        {
            get
            {
                ...
                _browser = _appConfigReader.ReadStringSettingFromAppConfig("Browser", "chrome");
